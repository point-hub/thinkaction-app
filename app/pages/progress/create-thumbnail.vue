...
const onNext = async () => {
  ...
  navigateTo(`/progress/create-caption?goal_id=${route.query.goal_id}`);
};
</script>
        ...
        <div class="flex-1 w-full text-sm space-y-4 overflow-y-auto">
          <div class="flex justify-start space-x-1 w-90%">
            ...
            <div class="bg-slate-100 text-slate-600 rounded-lg p-3">
              <p>
                Upload your image that represents your progress. You can add text, change colors, and customize it to make it truly yours!
              </p>
            </div>
          </div>
